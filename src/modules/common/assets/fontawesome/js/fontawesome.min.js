...
!(function () {
  ...
  function Wt(t) {
    ...
    if (a)
      return (
        (a = zt(t, a) || a), ut(_t.definitions, t, a) || ut(ot.styles, t, a)
      );
  }
  var _t = new c(),
    Ut = {
      noAuto: function () {
        (B.autoReplaceSvg = !1), (B.observeMutations = !1), Ft("noAuto");
      },
      config: B,
      dom: {
        i2svg: function () {
      ...
      parse: {
        icon: function (t) {
          ...
          if (
            "string" == typeof t &&
            (-1 < t.indexOf("".concat(B.familyPrefix, "-")) || t.match(R))
          ) {
    ...
    return (
      ...
      s
        ? ((p = (v = t).prefix),
          ...
          (v =
            !0 === (v = v.symbol)
              ? "".concat(p, "-").concat(B.familyPrefix, "-").concat(g)
              : v),
          [
            {
              tag: "svg",
        ...
        (e = i),
          ...
          t(
            k(
              ...
              {
                icon:
                  (B.showMissingIcons && i && Ht("missingIconAbstract")) || {},
              }
            )
          );
      })
  ...
  function fa(e, t) {
    ...
    0 === e.length
      ...
      : (B.mutateApproach === E ? g.requestAnimationFrame || ca : ca)(
          function () {
            var t =
                (!0 !== B.autoReplaceSvg && sa[B.autoReplaceSvg]) || sa.replace,
              a = ea.begin("mutate");
            e.map(t), a(), n();
          }
        );
        ...
        la ||
          ...
          Q(t).forEach(function (t) {
            ...
            "childList" === t.type &&
              ...
              !ia(t.addedNodes[0]) &&
              (B.searchPseudoElements && s(t.target), r(t.target)),
              "attributes" === t.type &&
                t.target.parentNode &&
              ...
              "attributes" === t.type &&
                ...
                n && e)
                  ...
                  : (a = t.target) &&
                    ...
                    a.classList.contains(B.replacementClass) &&
                    o(t.target));
          }));
      })),
      p &&
  ...
  var ga = ot.styles;
  function ha(t) {
    var a = "nest" === B.autoReplaceSvg ? pa(t, { styleParser: !1 }) : pa(t);
              ...
              return (
                ...
                (t = {
                  ...
                  extra: {
                    ...
                    styles: f,
                    classes: [
                      "".concat(B.familyPrefix, "-layers-counter"),
                    ].concat(l(s)),
                  },
                }),
                (a = t.content),
        ...
        (ot.hooks = k(
          ...
          {},
          {
            addPack: function (t, a) {
              (ot.styles[t] = k(k({}, ot.styles[t] || {}), a)), St(), Xt();
            },
            addPacks: function (t) {
              t.forEach(function (t) {
                var a = m(t, 2),
